...
export default function Home() {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-black">
      ...
      <div
        id="section-main"
        className={`bg-image-net bg-cover bg-center bg-opacity-50 mb-10 p-5`}
      >
        ...
        <div className="text-white mt-20 flex flex-col">
          <div className="flex flex-row items-center justify-center w-full pb-10">
            ...
            {/* /> */}
            <Link href={"/account/create"}>
              <ButtonBorder theme="b" className="btn-shadow btn-xl">
                Create Account
              </ButtonBorder>
            </Link>
            <Partition />
            <BorderButton theme="b" className="btn-shadow btn-xl">
              Get Started
            </BorderButton>
          </div>
        </div>
      ...
      <div className="text-white w-full p-2 pt-4 grid grid-cols-3 mt-10 mb-10">
        <p className="dm-sans text-3xl font-bold text-center text-glow">
          <CountUp end={230} duration={2} />
          K+
          <small className="block text-xl"> Books</small>
        </p>
        <p className="dm-sans text-3xl font-bold text-center text-glow">
          <CountUp end={400} duration={3} />K
          <small className="block text-xl"> Daily Users</small>
        </p>
        <p className="dm-sans text-3xl font-bold text-center text-glow">
          <CountUp end={300} duration={3.5} />K
          <small className="block text-xl"> Records</small>
        </p>
      </div>

      <div
        id="section-powered"
        className="text-white dm-sans flex flex-row items-center justify-center mt-10 rounded-t-full section_divider_top"
        style={{ background: "rgb(7,7,7)" }}
      >
        <div className="flex flex-col mt-10 w-1/3 pt-10">
          <Light
            color="#00ffff"
            blurRadius={150}
      ...
      >
        <div className="w-full flex flex-row mt-[100px] items-center justify-center">
          <div id="content" className="w-1/3 mt-10">
            <GradientHeading className="text-4xl from-[#003459] to-[#00A8E8]">
              Find words{" "}
              <b className="border-b-4 border-double uppercase">worth</b> your
              time
            </GradientHeading>
            <p className="text-white text-lg m-10 encode-sans-expanded-regular p-2">
          ...
          <div id="image" className="w-1/3 text-center items-center">
            <Light
              color="cyan"
              blurRadius={100}
      ...
      >
        <div className="w-full flex flex-row mt-[100px] items-center justify-center p-5 mb-10 pt-16">
          <div id="image" className="w-1/3 text-center items-center mb-10">
            <Light
              color="pink"
              blurRadius={100}
          ...
          <div id="content" className="w-1/3 mt-10">
            <GradientHeading className="text-4xl from-[#003459] to-[#00A8E8]  bg-gradient-to-r">
              Don{"'"}t think it, ask it!
            </GradientHeading>
            <p className="text-white text-lg m-10 encode-sans-expanded-regular p-2">
      ...
      <footer className="p-5 pl-20 pt-6 bg-gradient-to-t bg-gray-900">
        ...
        <div className="text-gray-600 flex flex-row items-center text-sm gap-5 mt-8">
          <p className="w-1/2">
